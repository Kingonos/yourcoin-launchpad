...
const Swap = () => {
  ...
  const openQuickSwap = () => {
    // QuickSwap URL for YOUR/USDC pair
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      min="0"
                    />
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 text-foreground font-semibold">
                      YOUR
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-card p-4 rounded-lg space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-foreground">1 YOUR = 0.1 USDC</span>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-foreground">~0.003 MATIC</span>
                  </div>
                </div>

                <div className="glass-card p-4 rounded-lg flex items-start gap-3 bg-primary/10">
                  <Info className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                  <div className="text-sm">
                    <p className="text-foreground mb-2">
                      Swaps are executed on QuickSwap DEX. You'll be redirected to complete the trade
                      with the current market rates.
                    </p>
                    <p className="text-muted-foreground">
                      Make sure you have MATIC for gas fees and YOUR tokens approved for trading.
                    </p>
                  </div>
                </div>
